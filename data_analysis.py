...
if fl is not None:
    ...
    os.chdir(r"C:\xampp\htdocs\dashboard_py")
...
#Create filter for Cust. City
country = st.sidebar.multiselect("Pick your city",df["Customer Country"].unique())
if not country:
    df2 = df.copy()
else:
...
st.sidebar.header("09020622017 - Afreza Ganteng")
